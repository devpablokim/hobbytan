import type { Cohort, Curriculum, Team, User, Submission, Post, Goal } from './types';
...
export const submissions: Submission[] = [
  { submissionId: 's1', userId: 'u1', teamId: 'team-alpha', cohortId: 'cohort-3', weekNumber: 0, assignmentId: 'a0-1', type: 'text', content: '안녕하세요, 마케팅팀 이수진입니다. AI를 활용한 콘텐츠 마케팅 자동화가 목표입니다.', files: [], deploymentUrls: [], fileUrl: null, fileName: null, fileSize: null, submittedAt: '2026-03-04T10:30:00', feedback: { comment: '목표가 명확합니다. 콘텐츠 자동화는 좋은 방향이에요!', score: 90, reviewedBy: 'admin-1', reviewedAt: '2026-03-05T09:00:00' } },
  { submissionId: 's2', userId: 'u2', teamId: 'team-alpha', cohortId: 'cohort-3', weekNumber: 0, assignmentId: 'a0-1', type: 'text', content: '영업팀 박민수입니다. CRM 데이터 분석에 AI를 적용하고 싶습니다.', files: [], deploymentUrls: [], fileUrl: null, fileName: null, fileSize: null, submittedAt: '2026-03-05T14:20:00', feedback: { comment: 'CRM + AI 조합 기대됩니다!', score: 85, reviewedBy: 'admin-1', reviewedAt: '2026-03-06T09:00:00' } },
  { submissionId: 's3', userId: 'u4', teamId: 'team-beta', cohortId: 'cohort-3', weekNumber: 1, assignmentId: 'a1-1', type: 'text', content: '프롬프트 3개 작성: 1) 보고서 요약 프롬프트, 2) 고객 응대 템플릿 생성, 3) 데이터 분석 요청', files: [], deploymentUrls: [], fileUrl: null, fileName: null, fileSize: null, submittedAt: '2026-03-12T16:00:00', feedback: null },
];
...
export const pendingUsers: User[] = [
  { userId: 'p1', displayName: '강태우', email: 'taewoo@example.com', photoURL: null, role: 'student', status: 'pending', cohortId: 'cohort-3', teamId: null, progress: { week0: { status: 'not-started', completedAt: null }, week1: { status: 'not-started', completedAt: null }, week2: { status: 'not-started', completedAt: null }, week3: { status: 'not-started', completedAt: null }, week4: { status: 'not-started', completedAt: null }, week5: { status: 'not-started', completedAt: null } } },
  { userId: 'p2', displayName: '나은서', email: 'eunseo@example.com', photoURL: null, role: 'student', status: 'pending', cohortId: 'cohort-3', teamId: null, progress: { week0: { status: 'not-started', completedAt: null }, week1: { status: 'not-started', completedAt: null }, week2: { status: 'not-started', completedAt: null }, week3: { status: 'not-started', completedAt: null }, week4: { status: 'not-started', completedAt: null }, week5: { status: 'not-started', completedAt: null } } },
];

// Team goals
export const goals: Goal[] = [
  { goalId: 'g1', teamId: 'team-alpha', cohortId: 'cohort-3', title: '전원 3주차 과제 완료', description: '팀원 전원이 Week 3 과제를 기한 내 제출', targetValue: 3, currentValue: 0, unit: '명', createdAt: '2026-03-03T09:00:00' },
  { goalId: 'g2', teamId: 'team-alpha', cohortId: 'cohort-3', title: '자동화 워크플로우 3건 구축', description: '팀 공동으로 실무 자동화 워크플로우 3건 완성', targetValue: 3, currentValue: 1, unit: '건', createdAt: '2026-03-03T09:00:00' },
  { goalId: 'g3', teamId: 'team-beta', cohortId: 'cohort-3', title: '팀 프로젝트 MVP 완성', description: 'AI 활용 프로젝트 MVP 배포까지 완료', targetValue: 1, currentValue: 0, unit: '건', createdAt: '2026-03-03T09:00:00' },
  { goalId: 'g4', teamId: 'team-beta', cohortId: 'cohort-3', title: '커뮤니티 활동 주 3회 이상', description: '매주 커뮤니티 게시글 또는 댓글 3회 이상 작성', targetValue: 15, currentValue: 8, unit: '건', createdAt: '2026-03-03T09:00:00' },
  { goalId: 'g5', teamId: 'team-gamma', cohortId: 'cohort-3', title: '전원 Week 2 완료', description: '팀원 전원 Week 2까지 과제 완료', targetValue: 3, currentValue: 0, unit: '명', createdAt: '2026-03-03T09:00:00' },
];
